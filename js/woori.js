...
window.addEventListener('DOMContentLoaded', () => {
  ...
  if (mainBtn) {
    mainBtn.addEventListener('click', () => {
      location.href = '/index.html'; // 절대경로로 지정 (🔥 중요)
    });
  }
});